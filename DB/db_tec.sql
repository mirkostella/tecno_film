...
('../img/img_film/sonic2.png', 'immagine di copertina del film Sonica 2: il film'),
...
('Jurassic Worl: il dominio', '8', "Termina l'incredibile viaggio iniziato con Jurassic Park mentre due generazioni si uniscono e combattono per il futuro nel film Jurassic World - Il Dominio.", '02:11:00', '2022/08/01', '12.99', '3.99'),
...
('Moonfall', '11', "In Moonfall vedremo la Luna che, spinta una forza misteriosa, viene sbalzata fuori dalla sua orbita per dirigersi in rotta di collisione con la Terra. A poche settimane dall’impatto fatale che annienterà il mondo, l’ex astronauta e dirigente NASA Jocinda Fowler ha un’idea per salvare il pianeta. Tuttavia, nessuno le crede, a parte Brian Harper, un uomo che appartiene al suo passato, e un simpatico complottista di nome K.C. Houseman. I tre improbabili eroi si lanceranno in una disperata missione spaziale lasciandosi alle spalle, forse per sempre, i loro affetti più cari, per cercare di scoprire un incredibile segreto.", '02:11:00', '2022/03/02', '12.99', '3.99'),
